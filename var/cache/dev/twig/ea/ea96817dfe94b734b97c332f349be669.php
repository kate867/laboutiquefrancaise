...
class __TwigTemplate_4e83c0ff2ea6e24996a4b375b9012c9e extends Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        // line 2
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_products", ["slug" => twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 2, $this->source); })()), "slug", [], "any", false, false, false, 2)]), "html", null, true);
    ...
    <a href=\"{{path('app_products', {'slug' : product.slug})}}\"><img src=\"/uploads/{{ product.illustration }}\" alt=\"{{ product.name }}\" class=\"img-fluid\"></a>
    <h5>{{product.name}}</h4>
    <span class=\"product-subtitle\">{{product.subtitle}}</span>
    <span class=\"product-price\">{{ ((product.price) / 100) |number_format(2)}} € </span>
</div>", "product/single_product.html.twig", "C:\\xampp\\htdocs\\laboutiquefrancaise\\templates\\product\\single_product.html.twig");
    }
}
